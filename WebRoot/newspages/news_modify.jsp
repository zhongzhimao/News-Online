...
<div id="main">
	...
	<div id="opt_area">
		...
		<form action="${pageContext.request.contextPath}/AdminServlet?action=doUpdateSubmit" method="post" enctype="multipart/form-data">
			<p>
				<label> 主题 </label> 
				<select name="ntid">
					 <!-- 迭代输出主题  -->
			...
			<p>
				...
				<label>上传图片 </label><input name="pic" type="file" class="opt_input" />
			...
			<c:if test="${fn:length(commentList)!=0}">
				...
				<c:forEach var="comment" items="${commentList}">
					<tr>
						...
						<td>${comment.cdate}</td>
						<td>
						    <a href="javascript:deleteComment(${comment.cid},${news.nid})">删除</a>
						</td>
					</tr>
					<tr>
